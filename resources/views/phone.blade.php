...
<head>
    ...
    <link rel="stylesheet preload prefetch" type="text/css" as="style"
        href="./lib/fonts/font_awesome/css/font-awesome.min.css" />
...
<script type="text/javascript" src="phone2.js"></script>

<!-- Deferred Scripts -->
<script type="text/javascript" src="./lib/jquery/jquery.md5-min.js" defer="true"></script>
<script type="text/javascript" src="./lib/Chart/Chart.bundle-2.7.2.min.js" defer="true"></script>
...
<script type="text/javascript" src="./lib/Croppie/croppie.min.js" defer="true"></script>
<script type="text/javascript" src="./lib/XMPP/strophe-1.4.1.umd.min.js" defer="true"></script>
