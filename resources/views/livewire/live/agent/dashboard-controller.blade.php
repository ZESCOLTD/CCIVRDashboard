<div>
    <div class="row">
        <div class="col">
            ...
            <div id="mic-status-alert-container">
                                    ...
                                    <li>
                                        ...
                                        @if ($agent != null)
                                            @switch($agent->status)
                                                ...
                                                @case('ON_BREAK')
                                                    <span class="badge badge-info"><i class="fas fa-circle mr-1"></i>On
                                                        break</span>
                                                @break
                            ...
                            <div class="col-md-4 border-right">
                                ...
                                <div class="mb-3">
                                    <label class="text-info small d-flex align-items-center">
                                        ...
                                        <span id="ws-info" wire:ignore class="badge badge-info ml-2">Not
                                            connected</span>
                                    </label>
                                </div>
                                <div>
                                    ...
                                    @if ($currentSession)
                                        ...
                                        <div class="small">
                                            ...
                                            <div><i class="far fa-clock mr-2"></i>To: {{ $currentSession->time_to }}
                                            </div>
                                        </div>
                                        <div>
                            ...
                            @elseif(!empty($searchQuery))
                                <div class="search-results shadow-lg mt-1">
                                    <div class="p-3 text-center">
                                        ...
                                        <p class="mb-0">No results found for <strong>"{{ $searchQuery }}"</strong>
                                        </p>
