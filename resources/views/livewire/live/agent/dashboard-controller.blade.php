<div class="container mt-4">
    <div class="row">
        <div class="col">
                    ...
                    <div class="knowledge-base-search mb-4">
                        ...
                        <div class="form-group position-relative">
                            ...
                            @if (!empty($searchResults))
                                <div
                                    class="search-suggestions position-absolute w-100 bg-white shadow-lg rounded mt-1 z-index-100">
                                    <ul class="list-group">
                                        @foreach ($searchResults as $result)
                                            <li class="list-group-item list-group-item-action"
                                                wire:click="selectTopic({{ $result['id'] }})" data-bs-toggle="modal"
                                                data-bs-target="#knowledgeModal" style="cursor: pointer;">
            ...
            <!-- Modal -->
            <div class="modal fade" id="knowledgeModal" tabindex="-1" role="dialog"
                aria-labelledby="knowledgeModalLabel" aria-hidden="true" wire:ignore.self>
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <h1 style="color: #f49434 ">
                            @if ($selectedTopic)
                        </h1>
                        ...
                        <div class="modal-header">
                            ...
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"
                                wire:click="$set('selectedTopic', null)"></button>
                        </div>
