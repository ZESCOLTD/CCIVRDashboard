            ...
            socket.addEventListener("message", (event) => {
                ...
                if (data.hasOwnProperty('type')) {
                    if (data.type == "Dial") {
                        ...
                        if (preStatus != null) {
                            if (data.dialstatus == "NOANSWER") {
                                preStatus.classList.remove("badge-success");
                                preStatus.classList.add("badge-danger");
                                preStatus.innerHTML = "AgentState.IDLE";
                            } else if (data.dialstatus == "RINGING") {
                                preStatus.classList.remove("badge-danger");
                                preStatus.classList.add("badge-warning");

                                preStatus.innerHTML = data.dialstatus;
                            } else if (data.dialstatus == "ANSWER") {
                                preStatus.classList.remove("badge-danger");
                                preStatus.classList.remove("badge-warning");
                                preStatus.classList.add("badge-success");
                                preStatus.innerHTML = data.dialstatus;
                            }
                        }
                    ...
                    if (data.type == "StasisEnd") {
                        ...
                        const app_data = data.channel.dialplan.app_data.split(',');
                        ...
                        if (id != undefined) {
                            ...
                            console.log("StasisEnd id: ", id);
                            // console.log("StasisEnd id: ", id);
                            const preStatus = document.getElementById('status-' + id);
