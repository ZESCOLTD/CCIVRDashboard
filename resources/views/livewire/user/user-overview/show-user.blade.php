<div>
    ...
    <div class="card p-0">
        <div class="card-body">
            ...
            <form wire:submit.prevent="click"
            ...
            >
                ...
                <div class="card-body">
                    ...
                    <button wire:click.prevent="store()" type="button" class="btn text-uppercase btn-success">Update
                    </button>
