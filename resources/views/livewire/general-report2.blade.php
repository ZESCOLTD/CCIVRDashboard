    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                                ...
                                <form wire:submit.prevent="generateReport">
                                    ...
                                    @if ($reportType === 'agent')
                                        <div class="form-group">
                                            <label for="selectedAgent">Filter by Agent (Optional)</label>
                                            <select class="form-control" id="selectedAgent"
                                                wire:model.defer="selectedAgent">
                                                <option value="">-- All Agents --</option>
                                                @foreach ($agents as $agent)
                                    ...
                                    <div class="form-group" id="timeRangeGroup">
                                        ...
                                        <div class="input-group">
                                            <input type="time" class="form-control" wire:model.defer="startTime"
                                                id="startTime">
                                            <div class="input-group-append">
                                                <span class="input-group-text">to</span>
                                            </div>
                                            <input type="time" class="form-control" wire:model.defer="endTime"
                                                id="endTime">
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="d-flex flex-wrap gap-2">
                                                <button type="button" class="btn btn-success flex-fill"
                                                    data-toggle="modal" wire:click="generateReport"
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <button type="button" class="btn btn-info btn-block"
                                    wire:click="saveAutomatedSettings">
                ...
                <div class="row mt-4">
                    <div class="col-md-12">
                        <div class="card" id="reportResultsCard"
                            style="@if (!$reportData) display:none; @endif">
                            <div class="card-header bg-orange text-white">
                                                ...
                                                <tbody>
                                                    @foreach ($reportData as $item)
                                                        <tr>
                                                            ...
                                                            @switch($reportType)
                                                                @case('daily')
                                                                    <td>{{ $item['my_destination_name'] ?? 'N/A' }}</td>
                                                                @break
        ...
        <div class="card" id="reportResultsCard" style="@if (!$reportData) display:none; @endif">
            <div class="card-header bg-orange text-white d-flex justify-content-between align-items-center">
                ...
                <div class="card-tools d-flex align-items-center gap-2">
                    ...
                    <button type="button" class="btn btn-tool" id="viewFullReportBtn" data-toggle="modal"
                        data-target="#{{ $reportType }}Modal">
                        <i class="fas fa-expand"></i>
                    </button>
...
<div class="modal fade" id="weeklyModal" tabindex="-1" role="dialog" aria-labelledby="weeklyModalLabel"
